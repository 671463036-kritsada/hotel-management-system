...
import 'list_screen_companents/boxListCompanent.dart';
import 'list_screen_companents/infoAbout.dart';
            ...
            Expanded(
              child: Stack(
                children: [
                                        ...
                                        builder: (context) {
                                          return FractionallySizedBox(
                                            ...
                                            child: SingleChildScrollView(
                                              child: Infoabout(
                                                status: booking.checkInStatus == true,
                  ...
                  const Positioned(bottom: 0, right: 0, left: 0, child: Bottomnavbar()),
                ],
              ),
            ),
          ],
